...
Vector3D(30.98-5, 193.19-5, 0) //0
,Vector3D (60.03-5, 189.49-5, 0)
,Vector3D (74.95-5, 174.71-5, 0)
,Vector3D (68.16-5, 155.68-5, 0)
,Vector3D (10.87-5, 185.05-5, 0)
,Vector3D (15.08-5, 178.44-5, 0)//5
,Vector3D (21.32-5, 192.08-5, 0)
,Vector3D (47.31-5, 194.02-5, 0)
,Vector3D (68.1-5, 184.2-5, 0)
,Vector3D (78.46-5, 161.9, 0)
,Vector3D (27.35-5, 178.09-5, 0)//10
,Vector3D (42.87-5, 177.55-5, 0)
,Vector3D (57.87-5, 170.05-5, 0)
,Vector3D (77.3-5, 151.72-5, 0)
};
...
static const byte morphCount = 4/*3*/;
/*
...
Vector3D cVectors[4] = {Vector3D(0.0000f,-19.4851f,-3.4480f),Vector3D(0.0000f,-23.5129f,-3.9973f),Vector3D(-0.6649f,-9.0778f,-2.1497f),Vector3D(0.0000f,-10.3950f,-2.5070f)};
   ...
   */
    ...
    */Vector3D DefaultVectors[14] = {Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),/*Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),*/};   
 
   Vector3D AngryVectors[14] = {
Vector3D(-8.72,-14.46+5,0.00),
Vector3D(-19.67,-6.98+5,0.00),
Vector3D(-16.54,8.26+5,0.00),
Vector3D(-18.16,14.32+5,0.00),
Vector3D(-1.66,-11.52+5,0.00),
Vector3D(-5.01,-15.45+5,0.00),
Vector3D(-5.39,-14.68+5,0.00),
Vector3D(-16.36,-12.93+5,0.00),
Vector3D(-19.56,-1.61+5,0.00),
Vector3D(-14.20,18.08+5,0.00),
Vector3D(-12.14,-14.60+5,0.00),
Vector3D(-15.83,-10.21+5,0.00),
Vector3D(-17.87,-0.05+5,0.00),
Vector3D(-16.37,18.32+5,0.00)};

Vector3D SurprisedVectors[14] = {
    Vector3D(0+5,0+5,0),//0
    Vector3D(0+5,0+5,0), //1
    Vector3D(0+5,0+5,0),
    Vector3D(0,0,0),
    Vector3D(0,0,0),
    Vector3D(0,0+5,0),//5
    ...
    Vector3D(0,0,0),
    Vector3D(0+5,0,0),
    /*Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),Vector3D(0,0,0),*/};   
 Vector3D SadVectors[14] = {
Vector3D(-8.34,-22.68,0.00),
Vector3D(-21.01,-24.14,0.00),
Vector3D(-19.35,-13.27,0.00),
Vector3D(-12.62,-9.02,0.00),
Vector3D(-1.25,-17.59,0.00),
Vector3D(-5.08,-18.44,0.00),
Vector3D(-5.39,-19.68,0.00),
Vector3D(-16.31,-26.47,0.00),
Vector3D(-21.37,-21.47,0.00),
Vector3D(-13.46,-1.90,0.00),
Vector3D(-12.35,-23.09,0.00),
Vector3D(-14.36,-28.25,0.00),
Vector3D(-18.55,-23.21,0.00),
Vector3D(-13.13,-2.32,0.00)};
